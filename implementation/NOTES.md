...
- 2026-05-19: `jsA8E/js/core/hw.js`, `A8E/AtariIo.c`, `jsA8E/tests/playfield_geometry_timing.test.js`: recentered the 336-pixel viewport around the corrected AHRM normal playfield origin. The normal 320-pixel playfield still starts at full-line x=104, but the visible crop now starts at x=96 so the playfield appears at screen x=8..327 again, matching the v1.2.0 Archon screenshot centering.
