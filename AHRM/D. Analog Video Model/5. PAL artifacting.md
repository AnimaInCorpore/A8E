...
= \quad & \left( M_{yuv2rgb} \begin{bmatrix} Y_2 \\ U_1 \\ V_1 \end{bmatrix} + M_{yuv2rgb} \begin{bmatrix} Y_2 \\ U_2 \\ V_2 \end{bmatrix} \right) \div 2 \\
= \quad & M_{yuv2rgb} \begin{bmatrix} Y_2 \\ 0 \\ 0 \end{bmatrix} + \left( M_{yuv2rgb} \begin{bmatrix} 0 \\ U_1 \\ V_1 \end{bmatrix} + M_{yuv2rgb} \begin{bmatrix} 0 \\ U_2 \\ V_2 \end{bmatrix} \right) \div 2 \\
= \quad & Y_2 + \frac{(RGB_1 - Y_1)}{2} + \frac{(RGB_2 - Y_2)}{2}
\end{aligned}
```
...
= \quad & Y_2 - \frac{Y_1 + Y_2}{2} + \frac{RGB_1 + RGB_2}{2}
\end{aligned}
```
