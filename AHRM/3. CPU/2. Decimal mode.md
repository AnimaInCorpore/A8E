...
All flags are computed after carries are propagated between nibbles but before decimal correction occurs.<sup>5</sup>
...
ADC produces the same results for invalid BCD encodings on the 65C02 as it does on the 6502, but SBC can produce different results.<sup>6</sup>
