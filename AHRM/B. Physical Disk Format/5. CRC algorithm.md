...
As with other CRC algorithms, this can be computed more quickly by precomputing a table of 16-bit modulo values (v × x<sup>16</sup> mod P) for all 256 byte values P, to quickly fold each group of 8 bits as they are shifted out the left:
