...
Between the first and second amplifier stages, external audio sources such as GTIA's CONSOL bit 3 on XL/XE machines, SIO audio, and PBI audio are included. This means that those sources are not affected by the input coupling of the first amplifier stage. In particular, GTIA audio shows much less decay over time than POKEY audio. 12K
