(function () {
  ...
  async function boot() {
    ...
    function setModifierButtons(modifier, active) {
      if (!atariKeyboard) return;
      let buttons = atariKeyboard.querySelectorAll(
